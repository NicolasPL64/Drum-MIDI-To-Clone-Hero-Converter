...
public class PanelOptions extends PanelUI {
    ...
    public static JTextField startPos = new JTextField("768");
    public static JTextField kickTime = new JTextField("96");
    public static JTextField channelId = new JTextField("10");
    public static JTextField midiTicks = new JTextField("1920");
    public static JTextField chTicks = new JTextField("768");
    public static JTextField ghostThreshold = new JTextField("0");
    public static JCheckBox fullFile = new JCheckBox("Full File", false);
    public static JCheckBox auto2xKick = new JCheckBox("Auto 2x Kick", true);
    public static JCheckBox autoToms = new JCheckBox("Auto Tom Optimisation", true);
    ...
    JLabel ghostThresholdLabel = new JLabel("Ghost velocity threshold:");
    ...
    public PanelOptions(ConverterScreen parent) {
        ...
        c.anchor = GridBagConstraints.CENTER;
        this.add(ghostThresholdLabel, c);
    ...
    public boolean shouldAutoToms() {
        return autoToms.isSelected();
    }
